...
# ax.grid()
datadict = {}
dataset_s = [xslist[0::time_divisor],yslist[0::time_divisor],zslist[0::time_divisor]]
dataset_e = [xelist[0::time_divisor],yelist[0::time_divisor],zelist[0::time_divisor]]
dataset_m = [xmlist[0::time_divisor],ymlist[0::time_divisor],zmlist[0::time_divisor]]
dataset_c = [xclist[0::time_divisor],yclist[0::time_divisor],zclist[0::time_divisor]]
